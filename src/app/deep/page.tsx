  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 font-[family-name:var(--font-geist-sans)]">
      <div className="container max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Guild Guild Deep Dive</h1>
        ...
        <section className="mb-12">
          ...
          <h4 className="text-xl font-bold mt-6 mb-2">Self-Curating Registry (SCR)</h4>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-8 mb-4">
            <li>A shared identity (Ethereum address) representing the collective</li>
            <li>A transparent record of who belongs to the guild and their contribution level</li>
            <li>The input/output interface connecting the guild to the broader Ethereum ecosystem</li>
          </ul>
          <p className="mb-6">
          ...
          <ul className="list-disc pl-8 mb-4">
            ...
            <li>Adjusting contribution weights to reflect changing participation levels</li>
            <li>Implementing rule changes for how the registry operates</li>
            <li>Executing collective decisions through the shared Ethereum address</li>
          </ul>
          <p className="mb-6">
          ...
          <ul className="list-disc pl-8 mb-4">
            ...
            <li>Configurable distribution triggers (manual, time-based, or threshold-based)</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-8 mb-6">
            <li><strong>Collective Bargaining Power</strong>: Individuals gain leverage by organizing with peers</li>
            <li><strong>Reduced Volatility</strong>: Pooled funding creates more stable income streams</li>
            <li><strong>Focus on Craft</strong>: Less time spent on fundraising and more on specialized work</li>
            <li><strong>Professional Development</strong>: Access to knowledge sharing and mentorship</li>
            <li><strong>Shared Identity</strong>: Connection to a recognized, respected collective</li>
          </ul>

          <h3 className="text-2xl font-bold mt-6 mb-4">For Funders</h3>
          <ul className="list-disc pl-8 mb-6">
            <li><strong>Simplified Discovery</strong>: Guilds create legible interfaces to specialized talent pools</li>
            <li><strong>Reduced Diligence Costs</strong>: Leverage collective reputation and curation</li>
            <li><strong>Aligned Incentives</strong>: Support self-organizing groups with proven track records</li>
            <li><strong>Increased Impact</strong>: More efficient resource allocation to high-value contributors</li>
            <li><strong>Long-term Relationships</strong>: Sustained support for critical domains</li>
          </ul>

          <h3 className="text-2xl font-bold mt-6 mb-4">For the Ecosystem</h3>
          <ul className="list-disc pl-8 mb-6">
            <li><strong>Knowledge Preservation</strong>: Guilds maintain specialized expertise over time</li>
            <li><strong>Coordination Efficiency</strong>: Reduced attention costs for matching talent with funding</li>
            <li><strong>Domain Specialization</strong>: Development of deep expertise in critical areas</li>
            <li><strong>Pluralism</strong>: Multiple overlapping guilds prevent capture and centralization</li>
            <li><strong>Public Goods Support</strong>: Sustainable funding models for non-monetizable work</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal pl-8 mb-6">
            <li><strong>Initial Formation</strong>: Small group identifies shared purpose and establishes basic registry</li>
            <li><strong>Contribution Differentiation</strong>: As collaboration emerges, contribution patterns become visible</li>
            <li><strong>Weight Calibration</strong>: Registry weights adjust to reflect relative contribution levels</li>
            <li><strong>Structure Refinement</strong>: Governance and distribution mechanisms evolve with group needs</li>
          </ol>
          <p className="mb-6">
          ...
          <h4 className="text-xl font-bold mt-4 mb-2">Qualitative Approaches</h4>
          <ul className="list-disc pl-8 mb-4">
            <li><strong>Simple Time-Based</strong>: Weights determined by time contributed (full-time vs. part-time)</li>
            <li><strong>Peer Review</strong>: Collaborative assessment of contribution value through tools like Coordinape</li>
            <li><strong>Governance-Driven</strong>: Collective decisions on appropriate weights through voting</li>
          </ul>

          <h4 className="text-xl font-bold mt-4 mb-2">Quantitative Approaches</h4>
          <ul className="list-disc pl-8 mb-6">
            <li><strong>Metric-Based</strong>: Objective measurements of output or impact</li>
            <li><strong>Token-Based</strong>: Representation of contribution through tokenized systems</li>
            <li><strong>Data-Driven</strong>: External signals from contribution tracking systems</li>
          </ul>
          <p className="mb-6">
...
PG1   PG2    PG3  (Each a guild with its own registry)
        ...
        <section className="mb-12">
          ...
          <dl className="mb-6">
            ...
            <dd className="pl-4 mb-2">A specialized SCR with a splitter component that receives and distributes resources.</dd>
            
            <dt className="font-bold mt-4">Curation Logic</dt>
            <dd className="pl-4 mb-2">The rules and processes by which a guild determines who belongs in its registry and at what weight.</dd>
            
            <dt className="font-bold mt-4">Guild</dt>
            <dd className="pl-4 mb-2">A self-organizing group of contributors sharing a common purpose, represented by a self-curating registry on Ethereum.</dd>
            
            <dt className="font-bold mt-4">Guilding</dt>
            <dd className="pl-4 mb-2">The practice of creating, stewarding, enabling, or studying guild-based organizations.</dd>
            
            <dt className="font-bold mt-4">Public Goods</dt>
            <dd className="pl-4 mb-2">Non-excludable resources that benefit the ecosystem but are difficult to monetize directly.</dd>
            
            <dt className="font-bold mt-4">Self-Curating Registry (SCR)</dt>
            <dd className="pl-4 mb-2">An on-chain record of data (typically addresses) that is maintained by the same entities listed within it.</dd>
            
            <dt className="font-bold mt-4">Splitting Logic</dt>
            <dd className="pl-4 mb-2">The rules determining how resources are distributed among guild members.</dd>
            
            <dt className="font-bold mt-4">Weighting</dt>
            <dd className="pl-4 mb-2">The relative allocation of voting power and/or resource distribution assigned to each member of a guild.</dd>
          </dl>
        </section>
      </div>
    </main>
