export default function DeepPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 transition-colors duration-300">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm">
        ...
        <div className="mt-8 p-4 border border-gray-300 dark:border-white rounded-lg">
          <p className="text-sm">
